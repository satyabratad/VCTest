namespace Bill2Pay.Model.DataContextMigrations
{
    ...
    public partial class UAT : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        NameControl = c.String(maxLength: 4),
                ...
                .ForeignKey("dbo.MerchantDetails", t => t.MerchantId)
                .ForeignKey("dbo.PSEDetails", t => t.PSEDetails_Id)
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PaymentYear = c.Int(nullable: false),
                        SubmissionDate = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        IsActive = c.Boolean(nullable: false),
                        DateAdded = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        UserId = c.Long(nullable: false),
                        Status_Id = c.Int(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PayeeAccountNumber = c.String(maxLength: 20),
                ...
                c => new
                    {
                        ...
                        ProcessingDate = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ImportDetails", "PSEDetails_Id", "dbo.PSEDetails");
            ...
            DropIndex("dbo.ImportDetails", new[] { "PSEDetails_Id" });
