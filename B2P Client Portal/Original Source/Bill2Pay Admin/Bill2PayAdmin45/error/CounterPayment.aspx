<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CounterPayment.aspx.vb" Inherits="Bill2PayAdmin45.CounterPayment" %>
...
<body>
    <form id="form1" runat="server" >
        ...
        <div class="content">
            ...
            <div class="header">Error - No Payment Methods</div>
            <div class="header_border"></div>

            <!--StartContent-->
            <div class="main_content">
                <p>There are no acceptable payment methods for this account.</p>
