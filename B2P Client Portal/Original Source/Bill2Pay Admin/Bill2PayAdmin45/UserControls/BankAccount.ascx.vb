...
#Region "::: Control Event Handlers :::"
        ...
        Protected Sub ddlBankAccountType_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlBankAccountType.SelectedIndexChanged
            ...
            Select Case Me.ddlBankAccountType.SelectedValue
                ...
                RaiseEvent ShowCommercialAccountMessage(GetGlobalResourceObject("WebResources", "BankAccountCommercialMsg").ToString() & " <span class=""bold"">" & B2P.Payment.BankAccountPayment.GetCompanyID(CStr(Session("UserClientCode"))) & "</span>", True)
