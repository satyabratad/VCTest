<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="callcenter.aspx.vb" Inherits="Bill2PayAdmin45.callcenter" %>
...
<body>
    ...
    <div class="content">
        ...
        <div class="header">Make a Call Center Payment</div>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                <ContentTemplate> 
                    <div id="ClientOfficeSelect" style="float:left; padding-right:5px;">
                        <telerik:RadComboBox ID="ddlAUClient"   Runat="server" Skin="Windows7" tabindex="1" OnSelectedIndexChanged="ddlAUClient_SelectedIndexChanged" 
                            AutoPostBack="true" CausesValidation="false" Visible="false"/>&nbsp;
                        <telerik:RadComboBox ID="ddlOffice"  runat="server" ToolTip="Select Office" Visible="false" DataValueField="Office_ID" DataTextField="Name" 
                            AppendDataBoundItems="true" CausesValidation="false"/>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" InitialValue="Select Office" ControlToValidate="ddlOffice" runat="server" text="*" ErrorMessage="Office is required"/>
                    </div>    
            ...
            <div id="Products" style="padding-top:5px; padding-bottom:5px;">
                            ...
                            <table width="98%" style="margin-left:20px;"  >                       
                                <tr style="height:25px;">
                                    ...
                                    <asp:Panel id="CartButtons1" runat="server" Visible="true">
                                        <td align="right"><des:ImageButton ID="btnCart1" runat="server" ImageUrl="/images/cartdisabled.jpg" ToolTip="Add to Cart" Enabled="false" CausesValidation="true" CssClass="noborder" ValidationGroup="Product1" /></td>
                                        <td align="right"><des:ImageButton ID="btnClearAll" runat="server" ImageUrl="/images/clearall.jpg" ToolTip="Clear All Products" Enabled="true" CausesValidation="false" /></td>
                                        <td align="right"><des:ImageButton ID="btnLookup1" runat="server" ImageUrl="/images/lookupdisabled.jpg" ToolTip="Lookup Account" Enabled="false" CausesValidation="false" /></td>
                                    </asp:Panel>
                                </tr>
                            </table>
                        </asp:Panel>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlProduct2" runat="server" Visible="false" DefaultButton="btnCart2">
                            <table width="98%" style="margin-left:20px;"  >
                                <tr style="height:25px;">
                                    <td>
                                        <telerik:RadComboBox ID="ddlProduct2" runat="server"  onSelectedIndexChanged="ddlProduct2_SelectedIndexChanged" 
                                         AutoPostBack="true" CausesValidation="false" AppendDataBoundItems="true"/>                                         
                                    </td>
                                    <td style="width:170px; text-align:left;">
                                    ...
                                    <td style="width:170px; text-align:left;"><asp:TextBox id="txtProduct2aInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" 
                                                runat="server" Enabled="True" TargetControlID="txtProduct2aInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                        </asp:FilteredTextBoxExtender>
                                    ...
                                    <td style="width:170px; text-align:left;"><asp:TextBox id="txtProduct2bInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender13" 
                                            runat="server" Enabled="True" TargetControlID="txtProduct2bInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                        </asp:FilteredTextBoxExtender>
              ...
              <asp:UpdatePanel id="updProduct3" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                ...
                <asp:Panel ID="pnlProduct3" runat="server" Visible="false" DefaultButton="btnCart3"> 
                 <table width="98%" style="margin-left:20px;"  >
                <tr style="height:25px;">
                    <td> <telerik:RadComboBox ID="ddlProduct3" runat="server" onSelectedIndexChanged="ddlProduct3_SelectedIndexChanged" 
                             AutoPostBack="true" 
                         CausesValidation="false" AppendDataBoundItems="true">
                         
                        </telerik:RadComboBox>
                    </td>
                    <td style="width:170px; text-align:left;"><asp:TextBox id="txtProduct3Input" runat="server" Width="150px" MaxLength="40"></asp:TextBox>
                    ...
                    <td style="width:170px; text-align:left;"><asp:TextBox id="txtProduct3aInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14" 
                                            runat="server" Enabled="True" TargetControlID="txtProduct3aInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                    </asp:FilteredTextBoxExtender>
               ...
               <asp:UpdatePanel id="updProduct4" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                ...
                <table width="98%" style="margin-left:20px;"  >
                <tr style="height:25px;">
                    <td> <telerik:RadComboBox ID="ddlProduct4" runat="server" onSelectedIndexChanged="ddlProduct4_SelectedIndexChanged" 
                             AutoPostBack="true"
                         CausesValidation="false" AppendDataBoundItems="true">
                         
                        </telerik:RadComboBox>
                    </td>
                    <td style="width:170px;"><asp:TextBox id="txtProduct4Input" runat="server" Width="150px" MaxLength="40"></asp:TextBox>
                     <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" 
                            runat="server" Enabled="True" TargetControlID="txtProduct4Input" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'">
                        </asp:FilteredTextBoxExtender>
                        <asp:TextBoxWatermarkExtender 
                        ...
                        <des:RequiredTextValidator ID="reqProduct4" runat="server" ControlIDToEvaluate="txtProduct4Input"  Group="Product4" ErrorMessage="*" />
                        
                     </td>
                     
                     
                     <td style="width:170px;"><asp:TextBox id="txtProduct4aInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender16" 
                                            runat="server" Enabled="True" TargetControlID="txtProduct4aInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                    </asp:FilteredTextBoxExtender>
                             ...
                             <td style="width:170px;"><asp:TextBox id="txtProduct4bInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender17" 
                                    runat="server" Enabled="True" TargetControlID="txtProduct4bInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                </asp:FilteredTextBoxExtender>
                    ...
                    <td>$&nbsp;<asp:TextBox id="txtProduct4Amt" runat="server" Width="100px"></asp:TextBox>
                        <asp:TextBoxWatermarkExtender 
                        ...
                        <des:RequiredTextValidator ID="reqAmount4" runat="server" ControlIDToEvaluate="txtProduct4Amt"  Group="Product4" ErrorMessage="*" />
                    </td>
              ...
              <asp:UpdatePanel id="updProduct5" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                ...
                <table width="98%" style="margin-left:20px;"  >
                <tr style="height:25px;">
                    <td> <telerik:RadComboBox ID="ddlProduct5" runat="server" onSelectedIndexChanged="ddlProduct5_SelectedIndexChanged" 
                             AutoPostBack="true"
                         CausesValidation="false" AppendDataBoundItems="true">
                         
                        </telerik:RadComboBox>
                    </td>
                    <td style="width:170px;"><asp:TextBox id="txtProduct5Input" runat="server" Width="150px"  MaxLength="40"></asp:TextBox>
                     <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" 
                            runat="server" Enabled="True" TargetControlID="txtProduct5Input" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'">
                        </asp:FilteredTextBoxExtender>
                        <asp:TextBoxWatermarkExtender 
                        ...
                        <des:RequiredTextValidator ID="reqProduct5" runat="server" ControlIDToEvaluate="txtProduct5Input"  Group="Product5" ErrorMessage="*" />
                    </td>
                    
                    <td style="width:170px;"><asp:TextBox id="txtProduct5aInput" runat="server" Width="150px" MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender18" 
                                            runat="server" Enabled="True" TargetControlID="txtProduct5aInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                    </asp:FilteredTextBoxExtender>
                             ...
                             <td style="width:170px;"><asp:TextBox id="txtProduct5bInput" runat="server" Width="150px"  MaxLength="40" ReadOnly="true" Enabled="false"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender19" 
                                    runat="server" Enabled="True" TargetControlID="txtProduct5bInput" FilterType="Custom, LowercaseLetters, UppercaseLetters, Numbers" ValidChars=" ,.&-'#_/">
                                </asp:FilteredTextBoxExtender>
                    ...
                    <td>$&nbsp;<asp:TextBox id="txtProduct5Amt" runat="server" Width="100px"></asp:TextBox>
                        <asp:TextBoxWatermarkExtender 
                        ...
                        <des:RequiredTextValidator ID="reqAmount5" runat="server" ControlIDToEvaluate="txtProduct5Amt"  Group="Product5" ErrorMessage="*" />
                    </td>
      ...
      <ContentTemplate>     
		...
		<asp:HiddenField ID="CardData" runat="server"  />   
                 ...
                 <table style="width:90%; margin-left:20px; padding-top:10px; ">
                    <tr style="height:25px;">
                        <td class="style11">Credit Card Number
                       
                        </td>
                        <td class="style7">
                            <asp:TextBox ID="tbCreditCardNumber" runat="server" MaxLength="20" Width="254px" CssClass="inputText"  AutoCompleteType="Disabled"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender ID="tbCreditCardNumber_FilteredTextBoxExtender" 
                                runat="server" TargetControlID="tbCreditCardNumber" FilterType="Custom, Numbers" ValidChars="*">
                            </asp:FilteredTextBoxExtender>
                             <asp:RegularExpressionValidator id="regCreditCard" runat="server" ControlToValidate="tbCreditCardNumber" 
                                 ValidationExpression="^((4\d{3})|(2[2-7]\d{2})|(5[1-5]\d{2})|(6011))-?\d{4}-?\d{4}-?\d{4}|3[4,7]\d{13}$"
                                 Display="Dynamic"  Text="*" ErrorMessage="Not a valid credit card" SetFocusOnError="True"></asp:RegularExpressionValidator>
                             <asp:RequiredFieldValidator ID="rqCreditCardNumber" 
                                runat="server" ControlToValidate="tbCreditCardNumber" ErrorMessage="Credit card number is required" 
                        ...
                        <telerik:RadComboBox ID="ddlYear" runat="server"   
                            AutoPostBack="false" CausesValidation="false" Width="60px">
                        </telerik:RadComboBox>&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <asp:TextBox ID="tbSecurityCode" runat="server" MaxLength="4" Width="54px" CssClass="inputText"  AutoCompleteType="Disabled"></asp:TextBox>
                             <asp:FilteredTextBoxExtender ID="tbSecurityCode_FilteredTextBoxExtender1" 
                                runat="server" TargetControlID="tbSecurityCode" FilterType="Numbers">
                            
                            </asp:FilteredTextBoxExtender>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                ControlToValidate="tbSecurityCode" Display="Dynamic"  Text="*"
                                ErrorMessage="Not a valid security code" SetFocusOnError="True" ValidationExpression="^[a-zA-Z0-9]{3,4}$"></asp:RegularExpressionValidator>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" 
                                runat="server" ControlToValidate="tbSecurityCode" ErrorMessage="Security code is required" 
                                SetFocusOnError="True" ToolTip="Tool TIp" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <asp:TextBox ID="tbFirstName" runat="server" MaxLength="20" Width="254px" CssClass="inputText"></asp:TextBox>
                                ...
                                runat="server" TargetControlID="tbFirstName" FilterType="Custom, LowercaseLetters, UppercaseLetters" ValidChars=" " >
                            </asp:FilteredTextBoxExtender>
                      
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
                                runat="server" ControlToValidate="tbFirstName" ErrorMessage="First name is required" 
                                SetFocusOnError="True" ToolTip="Tool TIp" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
                        ...
                        <td class="style13">
                            <asp:TextBox ID="tbLastName" runat="server" MaxLength="30" Width="254px" CssClass="inputText"></asp:TextBox>
                                ...
                                runat="server" TargetControlID="tbLastName" FilterType="Custom, LowercaseLetters, UppercaseLetters" ValidChars=" " >
                            </asp:FilteredTextBoxExtender>
                      
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" 
                                runat="server" ControlToValidate="tbLastName" ErrorMessage="Last name is required" 
                                SetFocusOnError="True" ToolTip="Tool TIp" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
            ...
            <asp:Panel ID="pnlACH" runat="server" Visible="false" DefaultButton="btnSubmit">
              ...
              <asp:label ID="lblCommercialMessage" runat="server" text="Note: please confirm with your bank that debits are allowed from the Company ID displayed on the confirmation page." 
               ForeColor="gray" Font-Italic="true" Font-Size="Small" Visible="false" CssClass="padding"></asp:label>
              <table style="width:90%; margin-left:20px;">            
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="tbBankRoutingNumber" runat="server" MaxLength="9" Width="254px" CssClass="inputText"></asp:TextBox>
                                ...
                                ControlToValidate="tbBankRoutingNumber" Display="Dynamic"  Text="*"
                        ...
                        <td class="style13">
                            <asp:TextBox ID="tbBankAccountNumber" runat="server" MaxLength="17" Width="254px" CssClass="inputText"  AutoCompleteType="Disabled"></asp:TextBox>
            ...
            <table style="width:90%; margin-left:20px;">
               ...
               <tr>
                ...
                <tr >
                    ...
                    <asp:RegularExpressionValidator ID="regHomePhone" runat="server" 
   ...
   <div style="padding-left:10px;"><asp:ValidationSummary id="ValidationSummary1"  runat="server" CssClass="ErrorSummary"  HeaderText="There's an error in the information you entered. Please correct the following errors and continue."
            ...
            <ContentTemplate>
                ...
                <asp:Button id="btnShowPopup" runat="server" style="display:none" />
                    ...
                    <asp:Panel ID="pnlMessage" runat="server" style="display:none; width:350px; background-color:White; border-width:2px; border-color:#336699; border-style:solid; padding:10px;" SkinID="PopUpPanel">
                        ...
                        <div style="text-align: right; width: 100%; margin-top: 5px;">
                            <asp:Button ID="btnClose" runat="server" Text="Close" Width="50px" CausesValidation="false" CssClass="buttons" />
                        </div>
                    </asp:Panel>
            </ContentTemplate>
         </asp:UpdatePanel>
             ...
             <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlPayBlock" runat="server" style="display:none; width:450px; background-color:White; border-width:2px; border-color:#336699; border-style:solid; padding:10px;" SkinID="PopUpPanel">
                        ...
                        <div style="text-align: right; width: 100%; margin-top: 5px;">
                            <asp:Button ID="btnBlockOverride" runat="server" Text="Yes, Override Block"  CausesValidation="false" CssClass="buttons" />
                            <asp:Button ID="btnBlockCancel" runat="server" Text="No, Cancel Transaction"  CausesValidation="false" CssClass="buttons" />
                        </div> 
                    </asp:Panel>
                </ContentTemplate>
             </asp:UpdatePanel>
             ...
             <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlLookup" runat="server" style="display:none; width:450px; background-color:White; border-width:2px; border-color:#336699; border-style:solid; padding:10px;" SkinID="PopUpPanel">
                        ...
                        <div style="text-align: right; width: 100%; margin-top: 5px;">
                            <asp:Button ID="btnLookupOK" runat="server" Text=" Continue "  CausesValidation="false" CssClass="buttons" />
                            <asp:Button ID="btnLookupCancel" runat="server" Text=" Cancel "  CausesValidation="false" CssClass="buttons" />
                        </div> 
                    </asp:Panel>
                </ContentTemplate>
             </asp:UpdatePanel>
             ...
             <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                ...
                <asp:Button id="btnShowError" runat="server" style="display:none" />
                        ...
                        <asp:Panel ID="pnlLookupError" runat="server" style="display:none; width:350px; background-color:White; border-width:2px; border-color:#336699; border-style:solid; padding:10px;" SkinID="PopUpPanel">
                            ...
                            <div style="text-align: right; width: 100%; margin-top: 5px;">
                                <asp:Button ID="btnLookupError" runat="server" Text="Close"  CausesValidation="false" CssClass="buttons" />
                            </div> 
                        </asp:Panel>
                </ContentTemplate>
             </asp:UpdatePanel>
             ...
             <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <Triggers>
                      ...
                      <ContentTemplate>     
                        ...
                        <des:Imagebutton ID="btnSubmit"  DisableOnSubmit="true" ImageUrl="/images/btnSubmitPaymentDisabled.jpg" runat="server" ToolTip="Submit Payment" text="Submit Payment" Enabled="false" CssClass="submit" OnClick="btnSubmit_Click" />
