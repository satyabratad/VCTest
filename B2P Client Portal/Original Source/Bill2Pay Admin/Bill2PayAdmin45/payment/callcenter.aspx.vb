...
Partial Public Class callcenter
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not UserSecurity.CallCenterScreen Then
    ...
    Private Sub loadData()
        ...
        a.GetAcceptedPaymentTypes(CStr(Session("ClientCode")), B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
    ...
    Protected Sub ddlAUClient_SelectedIndexChanged(ByVal o As Object, ByVal e As Global.Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles ddlAUClient.SelectedIndexChanged
        Dim a As New B2P.Web.Counter.PaymentSupport
        a.GetAcceptedPaymentTypes(CStr(ddlAUClient.SelectedItem.Text), B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
    ...
    Private Sub loadProducts()
        Try
            ...
            If RadioButtonList1.SelectedValue = "CC" Then
                listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.CreditCard, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
            Else
                listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.BankAccount, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
            End If
    ...
    Protected Sub ddlProduct1_SelectedIndexChanged(ByVal o As Object, ByVal e As Global.Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles ddlProduct1.SelectedIndexChanged
        Try
            ...
            Dim listProducts As List(Of String)
            If RadioButtonList1.SelectedValue = "CC" Then
                listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.CreditCard, product1Selected, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
            Else
                listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.BankAccount, product1Selected, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
            End If
            ddlProduct1.Items.Clear()
            ddlProduct1.DataSource = listProducts
            ddlProduct1.DataBind()
            If product1Selected <> "" Then
                ...
                Dim CurrentCategory As New B2P.Objects.Product(CStr(Session("UserClientCode")), ddlProduct1.SelectedValue, B2P.Common.Enumerations.TransactionSources.CallCenter)
                If CurrentCategory.WebOptions.AccountIDField1.Enabled = True Then
                    TextBoxWatermarkExtender1.WatermarkText = CurrentCategory.WebOptions.AccountIDField1.Label
                    txtProduct1Input.MaxLength = CurrentCategory.WebOptions.AccountIDField1.MaximumLength
                End If
        ...
        Try
            If RadioButtonList1.SelectedValue = "CC" Then
                If hasCreditCard <> "" Then
                    ...
                    vtr = y.ValidateTransaction(CStr(Session("UserClientCode")), tiItems, B2P.Web.Counter.PaymentSupport.PaymentTypes.CreditCard, tbCreditCardNumber.Text, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
                Else
                    btnSubmit.Enabled = False
                    btnSubmit.ImageUrl = "/images/btnSubmitPaymentDisabled.jpg"

                    vtr = y.ValidateTransaction(CStr(Session("UserClientCode")), tiItems, B2P.Web.Counter.PaymentSupport.PaymentTypes.CreditCard, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
                End If
            ...
            Else
                ...
                If hasProducts = True Then
                    vtr = y.ValidateTransaction(CStr(Session("UserClientCode")), tiItems, B2P.Web.Counter.PaymentSupport.PaymentTypes.BankAccount, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
                Else
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            Dim vtr As B2P.Web.Counter.PaymentSupport.ValidateTransactionReturn = validatePayment(CType(Session("tiListItems"), B2P.Payment.PaymentBase.TransactionItems), "submit")
            Select Case vtr.Result

                Case B2P.Web.Counter.PaymentSupport.ValidateTransactionReturn.Results.Valid

                    If vtr.ConvenienceFee = CDbl(Session("TempFee")) Then
                        If RadioButtonList1.SelectedValue = "CC" Then
                            ...
                            Else
                                If CBool(Session("ClickedButton")) = False Then
                                    ...
                                    ccpr = payCreditCard(CType(Session("tiListItems"), B2P.Payment.PaymentBase.TransactionItems), ccnumber)
    ...
    Private Function payCreditCard(ByVal tiListItems As B2P.Payment.PaymentBase.TransactionItems, ByVal creditCardNumber As String) As B2P.Payment.CreditCardPayment.CreditCardPaymentResults
        ...
        x.PaymentSource = B2P.Common.Enumerations.TransactionSources.CallCenter
        ...
        cc.ExpirationMonth = HttpUtility.HtmlEncode(ddlMonth.SelectedItem.Text)
        cc.ExpirationYear = HttpUtility.HtmlEncode(ddlYear.SelectedItem.Text)
    ...
    Private Sub productSelect(ByVal productNumber As Integer)
        ...
        If productDropdown.SelectedValue <> "" Then
            ...
            End With
            With buttonLookup
                Dim z As New B2P.Objects.Product(Session("UserClientCode").ToString, myProduct, B2P.Common.Enumerations.TransactionSources.CallCenter)
                Dim CurrentCategory As New B2P.Objects.Product(CStr(Session("UserClientCode")), myProduct, B2P.Common.Enumerations.TransactionSources.CallCenter)
    ...
    Private Sub checkBlock(ByVal productNumber As Integer)
        ...
        'Dim a As New B2P.Web.Counter.PaymentSupport
        'Dim ItemCount As Integer = a.GetAllowedItemCount(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
    ...
    Private Sub addCart(ByVal productNumber As Integer)
        ...
        If productDropdown.SelectedValue <> "" And productInput.Text <> "" And productAmount.Text <> "" Then
            ...
            If vtr.Result = B2P.Web.Counter.PaymentSupport.ValidateTransactionReturn.Results.Valid Then
                ...
                If RadioButtonList1.SelectedValue = "CC" Then
                    listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.CreditCard, productDropdown.SelectedValue, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
                Else
                    listProducts = y.GetSourceProductList(CStr(Session("UserClientCode")), B2P.Web.Counter.PaymentSupport.PaymentTypes.BankAccount, productDropdown.SelectedValue, B2P.Web.Counter.PaymentSupport.Sources.CallCenter)
                End If
