<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PinPadReturnChip.aspx.vb" Inherits="Bill2PayAdmin45.PinPadReturnChip" %>
     ...
     <fieldset style="width:450px;">
                ...
                <asp:Panel ID="pnlResults" runat="server">
                    ...
                    <div id="print_content">
                        <p style="font-size:medium; margin-left:5px; font-weight:bold;"><asp:Literal ID="litClientName" runat="server"></asp:Literal></p>
