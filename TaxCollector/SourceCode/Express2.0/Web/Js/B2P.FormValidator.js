...
function FormValidator() {
    ...
    var errorItemListStyle = "• ";      // List-style text to display before each error item in the error dialog (i.e., -, •, +, etc.).
    var errorMessageElement = "";       // The document element where validation error messages can be written.
    var errorMessageHeader = "";        // Message header text to display in the error dialog.
    ...
    /**
     * Sets whether the validation should display an alert dialog box.
     *
     * @param showAlerts Whether the validation should display an alert dialog box.
     */
    ...
    /**
     * Sets the error message header displayed in the error dialog before the error items.
     *
     * @param message The error message header to display in the error dialog before the error items.
     */
