...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlAddress1">
        <label class="control-label" for="txtPropAddress1" id="lblPropAddress1">
...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlAddress2">
        <label class="control-label" for="txtPropAddress2" id="lblPropAddress2">
...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlCity">
        <label class="control-label" for="txtPropCity" id="lblPropCity">
...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlState">
        <label class="control-label" for="txtLookupAccount3" id="lblPropState">
...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlZip">
        <label class="control-label" for="txtLookupAccount3" id="lblPropZip">
...
<div class="form-group form-group-sm">
    <asp:Panel runat="server" id="pnlAmount">
        <label class="control-label" for="txtLookupAccount3" id="lblPropAmount">
