...
Namespace B2P.PaymentLanding.Express.Web
    ...
    Public Class Temp : Inherits SiteBasePage
        ...
        Private Sub ConfigureSections()
            If BLL.SessionManager.ClientCode = B2P.Cart.EClientType.NonLookup Then
                ...
                custField.MaximumLength = 10
                SetValidatorProperties(txtAmount, custField, "hdAmount")
            Else
        ...
        Private Sub SetValidatorProperties(ByVal lookupTextBox As TextBox, ByVal customField As B2P.Objects.WebConfiguration.CustomField, ByVal hiddenField As String)
            ...
            Select Case customField.DataType
                ...
                Case B2P.Objects.WebConfiguration.CustomField.FieldDataType.Numeric
                    lookupTextBox.Attributes.Add("onkeypress", "return isNumberKey(event);")
                    lookupTextBox.Attributes.Add("onpaste", "return isNumberKey(event);")
            End Select
