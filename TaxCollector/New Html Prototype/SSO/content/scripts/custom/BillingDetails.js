...
var bill2payBillingDetails = {
    ...
    addBillingDetails: function(json=null)
    {
        ...
        UpdateDbObject();
        window.location.href = 'file:///D:\Tasks\Bill2Pay\Bill2Pay%20Html\PaymentConfirm.html?products=' + JSON.stringify(products)+',contactInfo='+JSON.stringify(contactInfo)+',billingDetails='+JSON.stringify(billingDetails);  
    }
