...
var bill2payAccountDetails = {
	...
	populateGrid: function () {
		...
		var cellClass='';
         ...
         html += '<td class="table-header" width="10%" align="right">Amount Due</td>';
...
//			}
	    ...
	    //subtotal
	     html += '<tr>';
	     html += ' <td class="table-row-bold" colspan="5" align="right">Subtotal (' + products.length + ' item(s)): </td>';
        ...
        var flag = 0;
         ...
         if (dbObject.Products != null){    
            for (var i = 0; i < dbObject.Products.length; i++) {
                ...
                flag = 0;
                if ($("#ddlCategories").val().toUpperCase()==dbObject.Products[i].ProductName.replace('_','&').toUpperCase()){
