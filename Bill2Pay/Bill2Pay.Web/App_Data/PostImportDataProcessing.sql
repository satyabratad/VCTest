...
AS
	...
	SET @ProcessLog = 'K1099: PROCESS BEGIN ON '+CAST(GETDATE() AS VARCHAR) +CHAR(13)+CHAR(10)
	...
	SET @ProcessLog = @ProcessLog + 'ARCHIVING OLD TRANSACTIONS, TOTAL COUNT : '+CAST(@@ROWCOUNT AS VARCHAR)+' ON' +CAST(GETDATE() AS VARCHAR)+CHAR(13)+CHAR(10)
	...
	BEGIN TRY
		...
		SET @ProcessLog = @ProcessLog + 'INSERTING NEW TRANSACTIONS, TOTAL COUNT : '+CAST(@@ROWCOUNT AS VARCHAR)++' ON' +CAST(GETDATE() AS VARCHAR)+CHAR(13)+CHAR(10)
	END TRY
	BEGIN CATCH
	...
	SET @ProcessLog = @ProcessLog + 'INSERTING NEW INFORMATION , COUNT : '+CAST(@@ROWCOUNT AS VARCHAR)++' ON' +CAST(GETDATE() AS VARCHAR)+CHAR(13)+CHAR(10)
